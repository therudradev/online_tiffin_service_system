...
{
$oid=intval($_GET['del']);
$sql="delete from tblorder where ID=:oid";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">All Tiffin Order</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="dashboard.php" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">All Tiffin Order</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<?php } ?>    </td> 
                                                <td><a href="view-order-detail.php?viewid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm">View Details</a>


<a href="all-order.php?del=<?php echo htmlentities ($row->ID);?>" class="btn btn-danger btn-sm" onClick="return confirm('Do you really want to delete?');">Delete</a>
                                                </td>
                                            </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
                                        </tbody>
