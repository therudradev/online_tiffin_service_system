...
<html>
<head>
<title>Online Tiffin Service System | Register page</title>
				...
				<form method="post">
				  ...
				  <div>
					<span>Mobile Number<label>*</label></span>
						<input type="text" placeholder="Mobile" name="mobno" maxlength="10" pattern="[0-9]+" required="true">
				  </div>
				   <div>
					 <span>Email Address<label>*</label></span>
						 <input type="email" placeholder="Email" name="email" id="email" required="true" onBlur="userAvailability()">
